...
with DAG(
    ...
    t3 = MySqlOperator(
        ...
        mysql_conn_id="mysql",
        sql=f"insert into alarms values ('{id}', '{{ task_instance.xcom_pull(task_ids=\"select_random_account_data\", key=\"return_value\") }}', 'test_title', 'test_content', 'test_link', '{now}', '{now}' );"
    )
